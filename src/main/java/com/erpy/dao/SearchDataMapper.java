...
public interface SearchDataMapper {
    ...
    ////////////////////////////////////////////////////////////////////////////
    @Select("SELECT * FROM search WHERE cp='${cpName}'")
    @Results(value = {
            @Result(property="_id",             column="appsid"),
            @Result(property="_product_id",     column="product_id"),
            @Result(property="_product_name",   column="product_name"),
    ...
    public List<SearchData> getCpSearchData(@Param("cpName") String cpName);

    ////////////////////////////////////////////////////////////////////////////
    @Select("SELECT * FROM search WHERE status='U' or status='I'")
    @Results(value = {
            @Result(property="_id",             column="appsid"),
            @Result(property="_product_id",     column="product_id"),
            @Result(property="_product_name",   column="product_name"),
